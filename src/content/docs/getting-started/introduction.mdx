...
Lunchpad turns any Novation Launchpad into a macro controller. Every pad becomes a button with its own look and colour, and every button runs a list of actions when you press it: play a sound, switch an OBS scene, press a hotkey, call a web address, and a lot more.
