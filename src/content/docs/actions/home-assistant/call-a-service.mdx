...
| **Service data (JSON)** | Optional. A JSON object with the service's fields, for example `{ "rgb_color": [255, 122, 26] }`. Empty sends no fields. The field colours the JSON as you type, and shows the placeholders in it, like the body of an [HTTP request](/actions/system/http-request/). |
